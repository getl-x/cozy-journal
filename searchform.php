...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr( get_theme_mod( 'cozy_journal_search_placeholder', __( '想找哪一页手账？', 'cozy-journal' ) ) ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
	</label>
